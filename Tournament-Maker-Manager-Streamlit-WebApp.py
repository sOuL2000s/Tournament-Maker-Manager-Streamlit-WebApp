...
# --- Firebase Setup ---
cred = credentials.Certificate("tournament-manager-75b5f-firebase-adminsdk-fbsvc-4d84a3856c.json")
...
if menu == "Create Tournament":
    ...
    t_type = st.selectbox("Type", ["Round Robin", "Single Elimination"])  # Single elimination not implemented yet
    if st.button("Create"):
